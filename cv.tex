...
I love creating tools for digital artists. During the PhD i learned to prototype and implement systems always considering out-of-core 3D environments as test case. In the past years i have also gained some experience in web-oriented graphics, designing and implementing methods for delivering computationally demanding 3D environments on a browser window. I mostly code in C++ and Python, but i can easily switch on web-oriented technologies. I like long walks, and annoy people talking about food.
